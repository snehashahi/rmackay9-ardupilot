...
#define AR_ATTCONTROL_HEEL_SAIL_P       1.0f // Comptete guess at defualts
...
public:
    ...
    // Sailboat heel(roll) angle contorller, either change heading or release sail to keep at maximum heel angle
