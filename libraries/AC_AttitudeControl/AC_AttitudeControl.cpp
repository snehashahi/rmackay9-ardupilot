...
const AP_Param::GroupInfo AC_AttitudeControl::var_info[] = {
    ...
    // @Units: cdeg/s/s
    // @Range: 0 72000
    // @Values: 0:Disabled, 9000:Slow, 36000:Medium, 54000:Fast
    // @Increment: 1000
    // @User: Advanced
    ...
    // @Range: 0 180000
    // @Increment: 1000
    // @Values: 0:Disabled, 36000:Slow, 108000:Medium, 162000:Fast
    // @User: Advanced
...
void AC_AttitudeControl::input_rate_bf_roll_pitch_yaw_3(float roll_rate_bf_cds, float pitch_rate_bf_cds, float yaw_rate_bf_cds)
{
    ...
    _attitude_ang_error = _attitude_ang_error * attitude_ang_error_update_quat;
    ...
    // Update the unused targets attitude based on current attitude to condition mode change
    _attitude_target_quat.from_rotation_matrix(_ahrs.get_rotation_body_to_ned());
    _attitude_target_quat = _attitude_target_quat*_attitude_ang_error;
    _attitude_target_quat.to_euler(_attitude_target_euler_angle.x, _attitude_target_euler_angle.y, _attitude_target_euler_angle.z);
    // Convert body-frame angular velocity into euler angle derivative of desired attitude
    ang_vel_to_euler_rate(_attitude_target_euler_angle, _attitude_target_ang_vel, _attitude_target_euler_rate);
