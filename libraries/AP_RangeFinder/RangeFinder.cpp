...
const AP_Param::GroupInfo RangeFinder::var_info[] = {
    ...
    // @Values: 0:None,1:Analog,2:MaxbotixI2C,3:LidarLiteV2-I2C,5:PX4-PWM,6:BBB-PRU,7:LightWareI2C,8:LightWareSerial,9:Bebop,10:MAVLink,11:uLanding,12:LeddarOne,13:MaxbotixSerial,14:TrOneI2C,15:LidarLiteV3-I2C,16:LeddarVu
    // @User: Standard
...
void RangeFinder::detect_instance(uint8_t instance)
{
    ...
    case RangeFinder_TYPE_ANALOG:
        ...
        break;
    case RangeFinder_TYPE_LEDDARVU:
        if (AP_RangeFinder_LeddarVu::detect(*this, instance, serial_manager)) {
            state[instance].instance = instance;
            drivers[instance] = new AP_RangeFinder_LeddarVu(*this, instance, state[instance], serial_manager);
        }
        break;
    default:
        break;
