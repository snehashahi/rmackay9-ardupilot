...
protected:
    ...
    // decode pilot input and convert to steering and throttle for manual mode
...
protected:
    ...
    // decode pilot input held in channel_steer and channel_throttle and return in steer_out and throttle_out arguments
