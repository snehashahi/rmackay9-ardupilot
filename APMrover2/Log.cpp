...
void Rover::Log_Write_Steering()
{
    ...
    g2.attitude_control.get_lateral_acceleration(lat_accel);
    struct log_Steering pkt = {
        ...
        lat_accel          : lat_accel,
        desired_turn_rate  : degrees(control_mode->get_desired_turn_rate()),
...
void Rover::Log_Write_Throttle()
{
    ...
    struct log_Throttle pkt = {
        ...
        desired_speed   : control_mode->get_desired_speed(),
        speed           : speed,
        accel_y         : accel.y
    };
    DataFlash.WriteBlock(&pkt, sizeof(pkt));
...
void Rover::Log_Write_Attitude()
{
    ...
    DataFlash.Log_Write_PID(LOG_PIDT_MSG, g2.attitude_control.get_throttle_speed_pid().get_pid_info());
}
...
void Rover::Log_Write_Rangefinder()
{
    ...
    struct log_Rangefinder pkt = {
        ...
        time_us               : AP_HAL::micros64(),
        lateral_accel         : control_mode->get_desired_lat_accel(),
...
const LogStructure Rover::log_structure[] = {
    ...
    { LOG_NTUN_MSG, sizeof(log_Nav_Tuning),
      "NTUN", "QHfHHf", "TimeUS,Yaw,WpDist,TargBrg,NavBrg,XT", "sdmdd-m", "FB0BB0" },
