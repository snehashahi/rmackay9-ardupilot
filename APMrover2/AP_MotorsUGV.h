...
public:
    ...
    bool have_vectored_thrust() const { return is_positive(_thrust_angle_max); }
...
protected:
    ...
    AP_Float _thrust_angle_max; // thrust angle max from center based on steering input.  Zero if thrust is unrelated to steering angle
